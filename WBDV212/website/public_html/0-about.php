        ...
        <body>
            ...
            <article id='about_page'>
                <div class='title_block'>
                    <h1 class='no_pad no_margin'>About</h1>
                </div>
                ...
                <div id='deliver'>
                    <div class='about_content sans-serif'>
                        <h1>What We Deliver</h1>
                            <dl>
                                <dt>Near-Perfect Quality</dt>
                                <dd>Our people are dedicated to bringing out the full beauty in each of our products to wholeheartedly ensure that customers can enjoy what they've bought
                                    without any remorse.
                                </dd>
                    ...
                    <div id='deliver_image_container'></div>
                </div>
                <div id='mission'>
                    <div class='about_content_mv mission_vision sans-serif'>
                        <h1>Mission</h1>
                        <p><span class=quote>"</span>We exist to embue the soul with satisfaction and to<br />
                        fulfill the human desire to chase the ultimate sense of luxury with<br />
                        fate in our core beliefs of ethical procedure and practice.<span class='quote_end'>"</span></p>
                    </div>
                </div>
                <div id='vision'>
                    <div class='about_content_mv mission_vision sans-serif'>
                        <h1>Vision</h1>
                        <p><span class=quote>"</span>Revolutionalize the jeweling industry by becoming the standard
                        <br />for revitalized ethics and unparalleled quality as a brand<br />that every customer can proudly wear day in and day out.<span class='quote_end'>"</span></p>
                    </div>
                </div>
            </article>
